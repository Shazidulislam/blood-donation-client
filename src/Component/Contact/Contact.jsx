    ...
    return (
        <div className=' grid grid-cols-1 gap-6 md:grid-cols-2 py-20' >
            ...
            <div data-aos="fade-left" >
               <h2 className='text-2xl md:text-4xl font-semibold text-[#D25D5D]' >Your Donation Can Make Someone’s Life Better</h2>
               <p className='text-sm text-gray-500 font-medium' >Your blood donation isn’t just a kind gesture — it’s a lifeline. Every drop you give can mean the world to someone fighting for their life. You have the power to bring hope, healing, and a second chance. Be the reason someone smiles again. Donate blood. Save lives. Every time you donate blood, you give more than just a few minutes of your time — you give someone a new chance at life. Whether it’s a child battling a disease, a mother during childbirth, or an accident victim in urgent need, your single act of kindness can be the difference between life and death. Blood cannot be manufactured;</p>
               <h2 className= 'text-2xl md:text-3xl py-3 font-bold text-[#403f3f]' >Opening Hours</h2>
               <div className='divider' ></div>
               <div className='flex justify-around items-center text-gray-500 '>
                <p>Sunday - Saturday</p>
                <div className='flex gap-1 items-center' >
                <span className='text-[#D25D5D]' ><IoMdStopwatch/> </span>

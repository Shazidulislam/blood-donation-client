    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 py-2">
      ...
      <div className="">
        ...
        <p className="text-sm text-gray-600 py-2">
          Together, we can build a healthier future for all. By donating blood,
          spreading awareness, and supporting one another, we bring hope and
          healing to those in need. Every small act counts — let’s unite, take
          action, and make our world a better and stronger place to live.
        </p>
